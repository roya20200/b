...
if ( !function_exists( 'ut_reduce_nav_menu_items' ) ) {

    function ut_reduce_nav_menu_items() {
...
if ( ! function_exists('ut_get_article_size') ) :
    ...
    function ut_get_article_size( $extra_class = '' ) {
        ...
        if( is_page() || isset( $is_grid_blog ) && $is_grid_blog ) {
...
if ( ! function_exists( 'ut_article_open_graph' ) ) : 
    ...
    function ut_article_open_graph() {
        ...
        if( is_single() ) {
			...
			if( ut_return_hero_config( 'ut_hero_catchphrase' ) ) {
			...
			if( ut_return_hero_config( 'ut_hero_caption_title' ) ) {
