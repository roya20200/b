				...
				<div id="qLoverlay" class="ut-qLoverlay">
					...
					<div class="ut-inner-overlay">
						...
						<?php if( ot_get_option('ut_image_loader_style', 'style_one') == 'text_draw' && ot_get_option( 'ut_image_loader_text_draw' ) ) :
							...
							// draw a test font first to get exact dimensions
							$svg->setFontSVG( THEME_DOCUMENT_ROOT . '/css/fonts/raleway-regular-webfont.svg');
							$svg->setFontSize(250);
							$svg->addText( ot_get_option( 'ut_image_loader_text_draw' ) );
							list( $textWidth, $textHeight ) = $svg->textDimensions( ot_get_option( 'ut_image_loader_text_draw' ) );										  
																	  
							$svg->clearSVG();										  
																	  
							$svg->addAttribute("id", "qLoverlay-SVG");
							$svg->setFontSVG( THEME_DOCUMENT_ROOT . '/css/fonts/raleway-regular-webfont.svg');
							$svg->setFontSize(250);
							$svg->setFontColor('#473BB1');
							$svg->setLetterSpacing(-.05);
							...
							$svg->addText( ot_get_option( 'ut_image_loader_text_draw' ), 'center', 'center' );
