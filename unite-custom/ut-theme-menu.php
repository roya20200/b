...
if( !apply_filters( 'ut_megamenu', true ) || ot_get_option( 'ut_header_layout', 'default' ) == 'side' || ot_get_option( 'ut_site_layout', 'onepage' ) == 'onepage' ) {
    return false;
}
...
if ( ! function_exists( '_ut_megamenu_js_translation' ) ) :
    ...
    function _ut_megamenu_js_translation( $strings ) {
		...
		$strings['megamenu_image_added_message']    = sprintf( esc_html__( 'Do not forget to make %1$s a child of %2$s', 'unite' ), '<span class="ut-is-megamenu-image">' . esc_html__( 'Image', 'unite' ) . '</span>', '<span class="ut-is-megamenu-column">' . esc_html__( 'Column', 'unite' ) . '</span>');
    ...
    class UT_Menu_Extensions {
        ...
        public function megamenu_meta_box() {
                ...
                echo '<h4>' , esc_html( 'Mega Menu', 'unite' ) , '</h4>';
                    ...
                    echo '<div class="ut-megamenu-panel-setting">';
						...
						echo '<label for="mm-menu-parent-title' , $_nav_menu_placeholder , '">';
							...
							echo '<input autocomplete="off" value="' , esc_attr__( 'Enter Mega Menu Title', 'unite' ), '" id="mm-menu-parent-title' , $_nav_menu_placeholder , '" name="menu-item[' , $_nav_menu_placeholder , '][menu-item-title]" type="text" class="regular-text menu-item-textbox input-with-default-title" title="' , esc_attr__( 'Mega Menu Title', 'unite' ), '" />';
            ...
            echo '<div id="ut-mm-column-for-menu" class="ut-mega-menu-setting">';
                ...
                echo '<div class="ut-megamenu-panel-setting">';
					...
					echo '<label for="mm-menu-column-title' , $_nav_menu_placeholder , '">';
						...
						echo '<span>', esc_html__( 'Title', 'unite' ) , '</span>';
						echo '<input autocomplete="off" value="' , esc_attr__( 'Enter Column Title', 'unite' ), '" id="mm-menu-column-title' , $_nav_menu_placeholder , '" name="menu-item[' , $_nav_menu_placeholder , '][menu-item-title]" type="text" class="regular-text menu-item-textbox input-with-default-title" title="' , esc_attr__( 'Column Title', 'unite' ), '" />';
            ...
            echo '<div id="ut-mm-image-for-menu" class="ut-mega-menu-setting">';
                ...
                echo '<h4>' , esc_html( 'Mega Menu Image', 'unite' ) , '</h4>';
                ...
                echo '<div class="ut-megamenu-panel-setting">';
                        ...
                        echo '<label for="mm-menu-image-title' , $_nav_menu_placeholder , '">';
                            ...
                            echo '<span>', esc_html__( 'Upload Image', 'unite' ) , '</span>';
							...
							echo '<input type="hidden" value="' , esc_attr__( 'Image', 'unite' ), '" id="mm-menu-column-title' , $_nav_menu_placeholder , '" name="menu-item[' , $_nav_menu_placeholder , '][menu-item-title]" />';
                ...
                echo '<p class="button-controls">';
                    echo '<button data-menu-id="' , $_nav_menu_placeholder , '" type="button" name="add-mm-menu-item" id="add-mm-image-to-menu" class="ut-ui-button ut-megamenu-image-button ut-button-full">' , esc_attr_e('Add Image', 'unite') , '</button>';
                echo '</p>';                     
        ...
        public function label( $item ) {
            ...
            if ( is_object( $item ) && isset( $item->object ) ) {
                ...
                switch( $item->object ) {
                    ...
                    $item->type_label = esc_html__( 'Image', 'unite' );
                    break;	
                    ...
                    <dt class="menu-item-handle">
                        ...
                        <span class="item-title">
							...
							<?php elseif( 'megamenu-image' == $item->object ) : ?>
                                ...
                                <span id="megamenu-image-<?php echo $item_id; ?>" class="ut-is-megamenu-image"><?php esc_html_e( 'Image', 'unite' ); ?></span>
                ...
                <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
									...
									<div>
										...
										<?php
											...
											$field_settings = array(
												...
												'field_value' => isset( $item->megamenu_button_border_radius_value ) ? $item->megamenu_button_border_radius_value : '',
												'field_class' => ''
											);
										...
										<?php
											...
											$field_settings = array(
												...
												'field_value' => isset( $item->megamenu_button_border ) ? $item->megamenu_button_border : '',
												'field_class' => ''
											);
										...
										<?php
											...
											$field_settings = array(
												...
												'type'        => 'colorpicker',
												'field_mode'  => 'rgb',
												'field_value' => isset( $item->megamenu_button_border_color ) ? $item->megamenu_button_border_color : '',
												'field_class' => ''
											);
										...
										<?php
											...
											$field_settings = array(
												...
												'type'        => 'colorpicker',
												'field_mode'  => 'rgb',
												'field_value' => isset( $item->megamenu_button_border_color_hover ) ? $item->megamenu_button_border_color_hover : '',
												'field_class' => ''
											);
										...
										<?php
											...
											$field_settings = array(
												...
												'field_value' => isset( $item->megamenu_button_border_style ) ? $item->megamenu_button_border_style : '',
												'field_class' => ''
											);
										...
										<?php
											...
											$field_settings = array(
												...
												'field_value' => isset( $item->megamenu_button_border_width ) ? $item->megamenu_button_border_width : '',
												'field_class' => ''
											);
									...
									<div>
										...
										<?php
											...
											$field_settings = array(
												...
												'field_value' => isset( $item->megamenu_button_padding ) ? $item->megamenu_button_padding : '',
												'field_class' => ''
											);
					...
					<?php if( 'megamenu-image' == $item->object ) : ?>
                        ...
                        <div class="ut-megamenu-settings">
                            ...
                            <h4><?php esc_html_e( 'Megamenu Image Settings', 'unite' ); ?></h4>
                                                       
                            <div id="ut-megamenu-settings-<?php echo $item_id; ?>" class="ut-megamenu-settings-inner">
                                
                                <h5><?php esc_html_e( 'Mega Menu Image', 'unite' ); ?></h5>
            ...
            if( $item->object == 'navigation-widget-area' ) {
                ...
                if( $item->object == "megamenu-button" ) {
                    ...
                    if( class_exists("UT_BTN") ) {
						...
						$megamenu_button_border_radius_value = isset( $item->megamenu_button_border_radius_value ) ? $item->megamenu_button_border_radius_value : 4;
					...
					$link_output = $args->before;
					$link_output .= '<img ' . $attributes . ' src="' . esc_url( $item->description ) . '" />';	
                    $link_output .= $args->after;
