...
if( !class_exists( 'UT_Custom_CSS' ) ) {	
    ...
    class UT_Custom_CSS {
        ...
        public function get_css_easing( $easing ) {
            ...
            return isset( $ut_recognized_css_easing[$easing] ) ? $ut_recognized_css_easing[$easing] : $easing;
        ...
        public function typography_css( $tag = '', $font_settings = '', $color = '', $important = false ) { 
        ...
        public function font_style_css( $settings, $exception = array(), $important = false ) {
            ...
            if( $settings['font-type'] == 'ut-google' ) {
				...
				$font = $settings['selector'] . ' {';
					...
					if( !empty( $settings['google-font-style']['font-size']) && !in_array( 'font-size', $exception ) ) {
						$font .= ' font-size: ' .  $settings['google-font-style']['font-size'] . ' ' . $important . ';';    
					}
					...
					if( !empty( $settings['google-font-style']['line-height']) ) {
						$font .= ' line-height: ' .  $settings['google-font-style']['line-height'] . ' ' . $important . ';';    
					}
            ...
            } elseif( $settings['font-type'] == 'inherit' ) {
