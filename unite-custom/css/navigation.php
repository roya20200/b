...
if( !class_exists( 'UT_Navigation_CSS' ) ) {	
    ...
    class UT_Navigation_CSS extends UT_Custom_CSS {
        ...
        public function custom_css() {
			...
			/* Header Height
            ================================================== */
            <?php if( $ut_header_top_layout == 'default' || $ut_header_top_layout == 'style-1' || $ut_header_top_layout == 'style-2' || $ut_header_top_layout == 'style-3' || $ut_header_top_layout == 'style-8' ) : ?>
            ...
            <?php if( ut_return_header_config( 'ut_navigation_skin', 'ut-header-light' ) == 'ut-header-custom' ) : ?>            
                ...
                ================================================== */
                if( ut_return_header_config( 'ut_navigation_ps_hover_state', 'off' ) == 'on' ) :
