        ...
        public function custom_css() {
            ...
            if( $ut_global_headline_style_2_spacing_top ) {
                ...
                .pt-style-2 .section-title:after {
                    margin: ' . $this->add_px_value( $ut_global_headline_style_2_spacing_top ) . ' auto 0;
                }
                
                .pt-style-2.header-left .page-title:after, 
                .pt-style-2.header-left .parallax-title:after, 
                .pt-style-2.header-left .section-title:after {
                    margin: ' . $this->add_px_value( $ut_global_headline_style_2_spacing_top ) . ' 0 0;
                }
                ...
                .pt-style-2.header-right .section-title:after {
                    margin: ' . $this->add_px_value( $ut_global_headline_style_2_spacing_top ) . ' 0 0 auto;        
                }';
