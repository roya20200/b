            ...
            if( apply_filters( 'ut_show_siteframe', 'hide' ) == 'show' ) : ?>
                ...
                if( ut_return_header_config( 'ut_navigation_skin' , 'ut-header-light' ) != 'ut-header-custom' && ut_return_header_config('ut_navigation_state' , 'off') != 'off' && ( ut_return_header_config('ut_navigation_scroll_position' , 'floating') == 'floating' || ut_return_header_config('ut_navigation_scroll_position' , 'floating') == 'fixed' && ut_return_header_config( 'ut_navigation_on_hero', 'off' ) == 'on' ) ) : ?>
                    ...
                    @media (min-width: 1025px) {
                        ...
                        #ut-sitebody.ut-site-border-top #header-section { 
        ...
        public function custom_css() {
            ...
            <style id="ut-top-header-css" type="text/css">
                ...
                <?php if( ut_page_option('ut_top_header', 'hide') == 'show' ) : ?>
                    ...
                    if( ut_return_header_config( 'ut_top_header_background_color' ) ) : ?>
                
                        
                        #header-section #ut-top-header { 
                            background: <?php echo ut_return_header_config( 'ut_top_header_background_color' ); ?> !important; 
                        }
                    ...
                    if( ut_return_header_config( 'ut_top_header_secondary_background_color' ) ) : ?>
                
                       
                        #header-section.ut-secondary-custom-skin #ut-top-header { 
                            background: <?php echo ut_return_header_config( 'ut_top_header_secondary_background_color' ); ?> !important; 
                        }
    ...
    class UT_Hero_Animation_CSS extends UT_Custom_CSS {
        ...
        public function custom_css() {
            ...
            <style id="ut-hero-animation-css" type="text/css">
				...
				<?php if( apply_filters( 'ut_show_hero', false ) && ( $ut_hero_type == 'image' || $ut_hero_type == 'splithero' || $ut_hero_type == 'tabs' || $ut_hero_type == 'video' || $ut_hero_type == 'imagefader' || $ut_hero_type == 'slider' ) ) : ?>
                    ...
                    @media(min-width: 768px) {               
                        ...
                        .ut-js #ut-sitebody.ut-hero-image-preloaded #ut-hero.heroFadeInLeft .parallax-image-container,
                        .ut-js #ut-sitebody.ut-hero-image-preloaded #ut-hero.heroFadeInRight .parallax-image-container {
                            width: calc(100% + 400px);
                            position: relative;
                            left: -200px;
                        }
                
                        .ut-js #ut-sitebody.ut-hero-image-preloaded #ut-hero.heroFadeInUp .parallax-image-container,
                        .ut-js #ut-sitebody.ut-hero-image-preloaded #ut-hero.heroFadeInDown .parallax-image-container {
                            height: calc(100% + 400px);    
                            position: relative;
                            top: -200px;
                        }
                    
                        .ut-js #ut-sitebody.ut-hero-image-preloaded #ut-hero.heroSlideInLeft .parallax-image-container,
                        .ut-js #ut-sitebody.ut-hero-image-preloaded #ut-hero.heroSlideInRight .parallax-image-container {
                            width: calc(100% + 400px);
                            position: relative;
                            left: -200px;
                        }
                
                        .ut-js #ut-sitebody.ut-hero-image-preloaded #ut-hero.heroSlideInUp .parallax-image-container,
                        .ut-js #ut-sitebody.ut-hero-image-preloaded #ut-hero.heroSlideInDown .parallax-image-container {
                            height: calc(100% + 400px);    
                            position: relative;
                            top: -200px;
                        }
                    ...
                    /* Slider */
                    .ut-js #ut-sitebody #ut-hero-slider,
                    .ut-js #ut-sitebody #ut-hero-captions,
                    .ut-js #ut-sitebody #ut-hero .ut-flex-control {
                        visibility: hidden;
                    }

                    .ut-js #ut-sitebody.ut-hero-image-preloaded #ut-hero-slider,
                    .ut-js #ut-sitebody.ut-hero-image-preloaded #ut-hero-captions,
                    .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .ut-flex-control {
                        visibility: visible;
                        -webkit-animation-fill-mode: both;
                        animation-fill-mode: both;
                    ...
                    @media(min-width: 768px) {
                        ...
                        ================================================== */
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero.<?php echo $ut_hero_image_animation_effect; ?> .parallax-image-container {
                         ...
                         * heroKenBurnsIn
                         */
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero.heroKenBurns .parallax-image-container {
                            visibility: visible !important;
                            -webkit-animation-fill-mode: both;
                                    animation-fill-mode: both;
                         ...
                         * heroKenBurnsOut 
                         */
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero.heroKenBurnsOut .parallax-image-container {
                            visibility: visible !important;
                            -webkit-animation-fill-mode: both;
                                    animation-fill-mode: both;
                    ...
                    if( $ut_hero_caption_animation_effect == 'BrooklynFadeInUpShortCut' ||
                        ...
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .hdh,
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .hth:not(.hth-animated),
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .hdb,
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .ut-hero-custom-logo-holder,
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .hero-btn-holder {
                            overflow: hidden;
                        }
                
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .hero-inner {
                            overflow: hidden;
                        }
                    ...
                    if( ut_collect_option( 'ut_hero_caption_animation_type', 'group' ) == 'group_split' && !is_singular('post') ) : ?>
                        ...
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .ut-hero-animation-element-upper.ut-hero-animation-element-start {
                            visibility: visible;
                            -webkit-animation-fill-mode: both;
                                    animation-fill-mode: both;
                        ...
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .ut-hero-animation-element-lower.ut-hero-animation-element-start {
                            visibility: visible;
                            -webkit-animation-fill-mode: both;
                                    animation-fill-mode: both;
                    ...
                    <?php else : ?>
                        ...
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .ut-hero-animation-element.ut-hero-animation-element-start {
                            visibility: visible;
                            -webkit-animation-fill-mode: both;
                                    animation-fill-mode: both;
                    ...
                    <?php if( in_array( $ut_hero_caption_animation_effect_split, array( 'BrooklynFadeInUp', 'BrooklynFadeInDown', 'BrooklynFadeInUpShortCut', 'BrooklynFadeInDownShortCut' ) ) ) : ?>
                        ...
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .ut-hero-style-5 .hero-title.hero-title-animated::after {
                            width: <?php echo $this->add_px_value( ut_return_hero_config('ut_hero_style_5_border_width', '30' ) ); ?>;
                        }
                
                    <?php else : ?>
                
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .ut-hero-style-5 .hero-title::after {
                            width: <?php echo $this->add_px_value( ut_return_hero_config('ut_hero_style_5_border_width', '30' ) ); ?>;
                        }                    
                    ...
                    .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .ut-hero-highlighted-item .ut-split-image,
                    .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .ut-hero-highlighted-item .ut-hero-video,
                    .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero .ut-hero-highlighted-item .ut-hero-form {
                        visibility: visible;
                        -webkit-animation-fill-mode: both;
                                animation-fill-mode: both;
                        -webkit-animation: heroFadeIn 1s linear;
                    ...
                    .ut-js #ut-sitebody.ut-hero-image-animated .hero-down-arrow-wrap .hero-down-arrow {
						visibility: visible;
                        -webkit-animation-fill-mode: both;
                                animation-fill-mode: both;
                        -webkit-animation: heroFadeIn 1s linear;
                    ...
                    if( ut_return_header_config( 'ut_navigation_hero_and_header_animation', 'off' ) == 'on' && (
