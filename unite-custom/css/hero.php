    ...
    class UT_Hero_CSS extends UT_Custom_CSS {
        ...
        public function custom_css() {
            ...
            <style id="ut-hero-custom-css" type="text/css">
                ...
                <?php if( !apply_filters( 'ut_maintenance_mode_active', false ) && ( $ut_hero_type == 'image' || $ut_hero_type == 'video' || $ut_hero_type == 'animatedimage' || $ut_hero_type == 'splithero' || $ut_hero_type == 'imagefader' ) ) :
                ...
                <?php echo ut_collect_option( 'ut_post_caption_description_margin', '', 'ut_' ); ?>
