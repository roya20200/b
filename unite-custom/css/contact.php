            ...
            <style id="ut-contact-section-css" type="text/css">
                ...
                if( $ut_csection_header_style == 'global' ) {
                    ...
                    if( $ut_global_headline_style_2_spacing_top ) { ?>
                        ...
                        #contact-section .pt-style-2.header-left .page-title:after, 
                        #contact-section .pt-style-2.header-left .parallax-title:after, 
                        #contact-section .pt-style-2.header-left .section-title:after {
                            margin: <?php echo $this->add_px_value( $ut_global_headline_style_2_spacing_top ); ?> 0 0;
                        }

                        #contact-section .pt-style-2.header-right .page-title:after, 
                        #contact-section .pt-style-2.header-right .parallax-title:after, 
                        #contact-section .pt-style-2.header-right .section-title:after {
