...
if( !function_exists('ut_before_top_header_hook') ) {
    
    function ut_before_top_header_hook(){
    
        do_action('ut_before_top_header_hook');
...
if( !function_exists('ut_after_footer_content_hook') ) {

    function ut_after_footer_content_hook(){
    
        do_action('ut_after_footer_content_hook');
