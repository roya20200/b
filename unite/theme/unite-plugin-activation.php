 ...
 * @version   2.6.1 for parent theme Edelweiss for publication on ThemeForest
	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			if ( true !== $this->is_tgmpa_complete() ) {
                ...
                /* modified by United Themes*/
                add_action( 'admin_menu', array( $this, 'redirect_to_welcome' ), 5 );
		...
		protected function do_plugin_install() {
			...
			if ( ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' === $_GET['tgmpa-install'] ) || ( isset( $_GET['tgmpa-update'] ) && 'update-plugin' === $_GET['tgmpa-update'] ) ) {
				...
				if ( $this->is_tgmpa_complete() ) {
                    ...
                    /* modified by United Themes */
                    echo '<p><a target="_parent" href="' . esc_url( admin_url( 'admin.php?page=unite-welcome-page' ) ) . '">' . esc_html__( 'Return to the Brooklyn Dashboard', 'tgmpa' ) . '</a></p>';
