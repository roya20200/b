...
;(function ($, window) {
    ...
    var vimelar = function(node, options) { // should be called on the wrapper div
        ...
        $('<iframe />', {
            ...
            allowfullscreen: 1
        }).prependTo(options.containment).wrap('<div id="vimelar-container-'+player_id+'" class="vimelar-container" style="overflow: hidden; position: absolute; z-index: 1; width: 100%; height: 100%"></div>').after('<div id="vimelar-overlay" style="width: 100%; height: 100%; z-index: 2; position: absolute; left: 0; top: 0;"></div>');
        ...
        var resize = function() {
            ...
            var width = $(window).width(),
                ...
                height = $(options.containment).height(),
