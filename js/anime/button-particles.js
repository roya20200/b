...
(function(global, factory) {
    ...
    Particles.prototype = {
        ...
        init: function () {
            ...
            this.canvas.className = 'ut-particles-canvas';
            this.canvas.style.display = 'none';
            this.wrapper = document.createElement('div');
            this.wrapper.className = 'ut-particles-wrapper';
            this.el.parentNode.insertBefore(this.wrapper, this.el);
            this.wrapper.appendChild(this.el);
            this.parentWrapper = document.createElement('div');
            this.parentWrapper.className = 'ut-particles';
        ...
        addTransforms: function (value, inout ) {
			...
			if( inout === 'out' ) {
				...
				this.wrapper.style[transformString] = translateProperty + '(0%)';
