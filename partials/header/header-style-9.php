...
<header id="header-section" data-style="<?php echo esc_attr( $header->style ); ?>" data-primary-skin="<?php echo $header->header_primary_skin_data(); ?>" data-secondary-skin="<?php echo $header->header_secondary_skin_data(); ?>" class="<?php echo $header->header_class(); ?>" data-line-height="<?php echo esc_attr( $header->header_data_lineheight() ); ?>" data-total-height="<?php echo esc_attr( $header->header_data_totalheight() ); ?>" data-scrolldepth="<?php echo $header->header_data_scrolldepth(); ?>" data-separator="on">
    ...
    <div class="grid-container hide-on-tablet hide-on-mobile">
        ...
        <div class="site-logo-wrap grid-15 tablet-grid-80 <?php echo $header->site_logo_mobile_grid(); ?> <?php echo $header->site_logo_flush_class(); ?>">
            ...
            <?php echo $header->create_site_logo('ut-logo-has-img'); ?>
            ...
            <div id="header-section-upper-area">
                ...
                <div class="ha-header-perspective clearfix">
                    ...
                    <div class="ha-header-front ha-header-front-upper clearfix">
                        ...
                        <div class="ut-header-extra-module ut-header-primary-extra-module <?php echo $header->extra_modul_class('primary'); ?> ut-header-extra-module-small ut-header-extra-module-<?php echo ut_return_header_config( 'ut_header_primary_toolbar_style', 'plain' ); ?> grid-50 hide-on-tablet hide-on-mobile">

                            <?php $header->create_primary_header_extra(); ?>

                        </div>

                        <div class="ut-header-secondary-extra-module ut-header-extra-module <?php echo $header->extra_modul_class('secondary'); ?> ut-header-extra-module-right ut-header-extra-module-small <?php echo $header->extra_modul_flush_class(); ?> grid-50 hide-on-tablet hide-on-mobile">
            ...
            <div id="header-section-lower-area" class="hide-on-tablet hide-on-mobile">
                ...
                <div class="ha-header-perspective clearfix">
                    ...
                    <div class="ha-header-front ha-header-front-lower clearfix">
                        ...
                        <div class="ut-header-tertiary-extra-module ut-header-extra-module <?php echo $header->extra_modul_class('tertiary'); ?> ut-header-extra-module-right ut-header-extra-module-small <?php echo $header->extra_modul_flush_class(); ?> grid-20 hide-on-tablet hide-on-mobile">
    ...
    <div class="grid-container hide-on-desktop">
        ...
        <div class="ha-header-perspective clearfix">
            ...
            <div class="ha-header-front clearfix">
                ...
                <div class="site-logo-wrap tablet-grid-80 <?php echo $header->site_logo_mobile_grid(); ?> <?php echo $header->site_logo_flush_class(); ?>">
