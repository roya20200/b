...
// @todo 
$hide_meta_categories = isset( $hide_meta_categories ) ? $hide_meta_categories : false; 
$hide_meta_footer = isset( $hide_meta_footer ) ? $hide_meta_footer : false; 
            ...
            <div class="ut-blog-grid-content-wrap"> 
                ...
                <div class="entry-content clearfix">
                    ...
                    <?php if( !has_post_thumbnail() ) : ?>
                        ...
                        <?php echo unite_get_excerpt_by_id( $post, ot_get_option( 'ut_blog_grid_excerpt_length', 20 ) * 2 ); ?>
