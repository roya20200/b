...
define('UT_Bucket', 'https://licensing.unitedthemes.com/verify-purchase/public-images/');
	...
	function ut_demo_importer_info() {
		...
		return array(
            ...
            'demo_original' => array(
                ...
                'sliderev'	=> array( 'Hero-Website-1.zip' )
            ),
			'demo_one' => array(
				'id'			=> 1,
				'name'      	=> 'Bklyn Demo #1 Classic (Redesign)',
