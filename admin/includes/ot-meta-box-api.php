...
if ( !class_exists( 'OT_Meta_Box' ) ) {
    ...
    class OT_Meta_Box {
        ...
        public function register_settings_styles() {
            ...
            if( get_post_type( $post_ID ) == 'portfolio' || get_post_type( $post_ID ) == 'post' ) {
                    ...
                    echo '<div class="' . implode( ' ', $section_classes ) . '">';
                        ...
                        echo '<div class="ut-panel-description">';
                            ...
                            if( isset( $_args['field_global'] ) && $_args['field_global'] == 'on' ) {
                                ...
                                echo '<div class="ut-switch ut-switch-for-globals" data-on="' , esc_html( 'custom', 'unitedthemes' ) ,  '" data-off="' , esc_html( 'global', 'unitedthemes' ) ,  '">';
                                    ...
                                    echo '<input data-option="' . $_args['field_id'] . '" id="' . $_args['field_id'] . '_global_overwrite" data-nonce="'. esc_attr( $nonce ) .'" data-post="' . esc_attr( $post->ID ) . '" name="' . $_args['field_id'] . '_global_overwrite" type="checkbox" ' , ( isset( $global_overwrite ) ? checked( true, $global_overwrite ) : '' ) ,' />';               
                                    echo '<label for="' , esc_attr( $_args['field_id'] ) , '_global_overwrite"></label>';
                        ...
                        echo '<div class="' . implode( ' ', $section_classes ) . '">';
                            ...
                            if( isset( $_args['field_global'] ) && $_args['field_global'] == 'on' && !$global_overwrite ) {
                                ...
                                // parse theme default into metabox if global is active
                                $theme_options_value = str_replace( 'ut_page_', 'ut_global_', $_args['field_id'] );

                                $_args['field_value'] = ot_get_option( $theme_options_value );

                            }

                            echo '<div id="switch_overlay_' , $_args['field_id'] , '" class="ut-global-switch-overlay ' , $overlay_state , '">';
                
                                // js will insert loader here
        ...
        function build_meta_box( $post, $metabox ) {
            ...
            if ( isset( $this->meta_box[ 'type' ] ) && $this->meta_box[ 'type' ] == 'simple' || !isset( $this->meta_box[ 'type' ] ) ) {
                ...
                echo '<div id="ut-metabox-tabs" class="ui-tabs">';
					...
					// hide metabox until windows loaded
