    ...
    function ot_type_background( $args = array() ) {
        ...
        echo '<div class="grid-50 tablet-grid-100 mobile-grid-100">';
            ...
            echo '<div id="' . esc_attr( $field_id ) . '_media" class="ut-ui-media-wrap">';
                ...
                if ( isset( $field_value['background-image'] ) && preg_match( '/\.(?:jpe?g|png|gif|ico)$/i', $field_value['background-image'] ) ) {
                    ...
                    echo '<div id="' . esc_attr( $field_id ) . '_tab_icon">';
                        ...
                        echo '<div class="ut-numeric-slider-outer-wrap">';
                            ...
                            echo '<div class="ut-numeric-slider-wrap">';
                                ...
                                echo '<input data-min="10" data-max="30" type="input" class="ut-ui-form-input ut-numeric-slider-helper-input" data-tooltip="' . esc_html( 'Max Value:', 'unitedthemes' ) . ' 30" value="' . ( isset( $field_value['icon_size'] ) ? esc_attr( $field_value['icon_size'] ) : '14' ) . '" autocomplete="off">';
                ...
                if ( in_array( 'border-settings', $ot_recognized_button_builder_fields ) ) {
                    ...
                    echo '<div id="' . esc_attr( $field_id ) . '_tab_border">';
                        ...
                        echo '<div class="ut-numeric-slider-outer-wrap">';
                            ...
                            echo '<label for="' . esc_attr( $field_id ) . '_button_border_radius">' . __('Button Border Radius' , 'unitedthemes') . '</label>';

                            echo '<div class="ut-numeric-slider-wrap">';

                                echo '<input autocomplete="off" type="hidden" name="' . esc_attr( $field_name ) . '[button_border_radius]" id="' . esc_attr( $field_id ) . '_button_border_radius" class="ut-numeric-slider-hidden-input" value="' . ( isset( $field_value['button_border_radius'] ) ? esc_attr( $field_value['button_border_radius'] ) : '' ) . '" data-min="0" data-max="50" data-step="1">';

                                echo '<input data-min="0" data-max="50" type="input" class="ut-ui-form-input ut-numeric-slider-helper-input" data-tooltip="' . esc_html( 'Max Value:', 'unitedthemes' ) . ' 50" value="' . ( isset( $field_value['button_border_radius'] ) ? esc_attr( $field_value['button_border_radius'] ) : '' ) . '" autocomplete="off">';
                        ...
                        echo '<div class="ut-numeric-slider-outer-wrap ut-numeric-slider-outer-wrap-half">';
                            ...
                            echo '<label for="' . esc_attr( $field_id ) . '_button_border_width">' . __('Button Border Width' , 'unitedthemes') . '</label>';

                            echo '<div class="ut-numeric-slider-wrap">';

                                echo '<input autocomplete="off" type="hidden" name="' . esc_attr( $field_name ) . '[button_border_width]" id="' . esc_attr( $field_id ) . '_button_border_width" class="ut-numeric-slider-hidden-input" value="' . ( isset( $field_value['button_border_width'] ) ? esc_attr( $field_value['button_border_width'] ) : '' ) . '" data-min="0" data-max="50" data-step="1">';

                                echo '<input data-min="0" data-max="50" type="input" class="ut-ui-form-input ut-numeric-slider-helper-input" data-tooltip="' . esc_html( 'Max Value:', 'unitedthemes' ) . ' 50" value="' . ( isset( $field_value['button_border_width'] ) ? esc_attr( $field_value['button_border_width'] ) : '' ) . '" autocomplete="off">';
                    ...
                    echo '<div id="' . esc_attr( $field_id ) . '_tab_icon">';
                        ...
                        echo '<div class="ut-numeric-slider-outer-wrap">';
                            ...
                            echo '<div class="ut-numeric-slider-wrap">';
                                ...
                                echo '<input data-min="10" data-max="30" type="input" class="ut-ui-form-input ut-numeric-slider-helper-input" data-tooltip="' . esc_html( 'Max Value:', 'unitedthemes' ) . ' 30" value="' . ( isset( $field_value['button_icon_size'] ) ? esc_attr( $field_value['button_icon_size'] ) : '14' ) . '" autocomplete="off">';
    ...
    function ot_type_page_select( $args = array() ) {
        ...
        echo '<div class="ut-ui-select-field">';
            ...
            if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
                ...
                echo '<option value="custom" ' . selected( $field_value, 'custom', false ) . '>' . __( 'Custom Link', 'option-tree' ) . '</option>';
...
if ( ! function_exists( 'ot_type_panel_headline' ) ) {
    ...
    function ot_type_panel_headline( $args = array() ) {
        ...
        extract( $args );
        echo '<div class="ut-panel-headline-content"><h1 class="ut-panel-title">' . wp_specialchars_decode( $field_label ) . '</h1></div>';
...
if ( ! function_exists( 'ot_type_section_headline' ) ) {
    ...
    function ot_type_section_headline( $args = array() ) {
        ...
        echo '<div class="ut-section-headline-content"><h2 class="ut-section-title">' . wp_specialchars_decode( $field_label ) . '</h2></div>';
...
if ( ! function_exists( 'ot_type_upload' ) ) {
    ...
    function ot_type_upload( $args = array() ) {
        ...
        echo '<div class="ut-ui-upload-parent ' . esc_attr( $field_class ) . '">';
            ...
            /* add media button */
            echo '<button class="ut-media-upload ut-ui-button ut-single-media-upload" rel="' . $post_id . '" title="' . __( 'Add Media', 'option-tree' ) . '">' . __( 'Add Media', 'option-tree' ) . '</button>';
                ...
                echo '<div class="' . $fields_grid . '">';
                    ...
                    echo '<div class="ut-numeric-slider-outer-wrap">';
                        ...
                        echo '<div class="ut-numeric-slider-wrap">';
                            ...
                            echo '<input min="1" max="' . esc_attr( $border_max_width ) . '" type="input" class="ut-ui-form-input ut-numeric-slider-helper-input" data-tooltip="' . esc_html( 'Max Value:', 'unitedthemes' ) . ' ' . esc_attr( $border_max_width ) . '" value="' . esc_attr( $value ) . '" autocomplete="off">';
                            echo '<div id="ut_numeric_slider_' . esc_attr( $field_id ) . '_border_radius" class="ut-numeric-slider ui-slider ui-slider-horizontal"></div>';
        ...
        echo '<div class="ut-ui-select-field">';
			...
			if( !empty( $nav_menus ) && is_array( $nav_menus) ) {
				...
				echo '<select autocomplete="off" name="' . esc_attr( $field_name ) . '" id="' . esc_attr( $field_id ) . '" class="ut-ui-form-select ut-ui-select ' . esc_attr( $field_class ) . '">';
                    ...
                    echo '<option value="">' . __( 'Select Menu', 'option-tree' ) . '</option>';                
