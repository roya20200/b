        ...
        $settings = apply_filters( 'ut_bklyn_metabox_settings', array(
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'required' => array(
                        'ut_page_hero_type' => 'image|video|animatedimage|imagefader|splithero|tabs|transition|slider|custom',
                    )
                ),
                array(
            ...
            'fields' => array(
                ...
                */
                ...
                array(
                    ...
                    'metapanel' => 'ut-hero-content-caption-title-settings',
                    'label' => 'Text',
                    'desc' => 'This field also accepts HTML tags and shortcodes. Will be used as "SEO" open graph title as well.',
				...
				array(
					...
					'required' => array(
                        'ut_portfolio_link_type' => 'onepage|global'
                    ),
                    'pages' => $post_type_support_3,
                ), 
                ...
                array(
                    ...
                    'desc' => '<strong>This option is deprecated. Please use section or row streching options in order to create full width pages and set this option to "no, thanks!".</strong>',
                    'type' => 'select',
                    'std' => 'off',
                    'choices' => array(
                        array(
